...
class gameApiController extends controller {
    ...
    public function displayAction() {
        echo "<pre>";
        var_dump($this->session->get('hand')['active']['dealer']);
    }
    ...
    public function startAction($gametable = null, $gameid = null) {
        ...
        $result[0][0] .= $this->prepareCardHtml('dealer', 1, 'red_joker.png');
    ...
    private function prepareCardHtml($role = 'player', $index = '', $image = '') {
        ...
        $offset = $index * 30;
        return '<div id="' . $role . '-card-' . $index . '" class="the-card" style="left:' . $offset . 'px;background-image: url('. "'" . $image_path . "'" . ');"></div>';
    }
