...
<html>
    <head>
        ...
        <?php $this->config->includeScript('game.js');?>
    ...
    <body>
        <div class="loader">
            ...
            <h4>Working...few moments left</h4>
        </div>
        ...
        <div class="container col-sm-8">
            <div class="col-sm-12 header no-print">
                <div class="header-content">
                    ...
                    <div class="col-sm-8 header-right">
                        ...
                        <span class="float-right"><img src="<?= $this->template->getImage("img-right.png")?>" style="height:75px;opacity:0.7;"></span>
                    </div>
                </div>
            </div>
            <?php 
            ...
            ?>
            <div id="content" class="content row board-section" style="padding-bottom:40px;">
